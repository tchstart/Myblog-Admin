<template>
  <div>
    <div class="avatar-box">
      <div style="display: inline-block" @click="selectAttachmentDrawer=true">
    ...
    <el-drawer :visible.sync="selectAttachmentDrawer" direction="rtl" title="选择头像">
      <v-attachment-select ref="selectAttachmentDrawer" style="padding: 0 20px" @selected="updateAvatar" />
    </el-drawer>
  </div>
</template>
